...
class KotlinParser(input: TokenStream) : Parser(input) {
	...
	fun  lambdaParameter() : LambdaParameterContext {
		...
		try {
			...
			this.state = 2853
			errorHandler.sync(this)
			when ( interpreter!!.adaptivePredict(_input!!,431,context) ) {
			1   -> if (true){
			this.state = 2842
			errorHandler.sync(this);
			_la = _input!!.LA(1)
	...
	fun  objectLiteral() : ObjectLiteralContext {
		...
		try {
			...
			this.state = 2951
			errorHandler.sync(this)
			when ( interpreter!!.adaptivePredict(_input!!,449,context) ) {
			1 -> {
			enterOuterAlt(_localctx, 1)
			if (true){
			this.state = 2920
	...
	fun  superExpression() : SuperExpressionContext {
		...
		try {
			...
			this.state = 2972
			errorHandler.sync(this)
			when ( interpreter!!.adaptivePredict(_input!!,452,context) ) {
			1   -> if (true){
			this.state = 2956
			match(LANGLE) as Token
			this.state = 2960
	...
	fun  ifExpression() : IfExpressionContext {
		...
		try {
			...
			this.state = 3070
			errorHandler.sync(this)
			when ( interpreter!!.adaptivePredict(_input!!,470,context) ) {
			1 -> {
			enterOuterAlt(_localctx, 1)
			if (true){
			this.state = 2981
			...
			this.state = 3063
			errorHandler.sync(this)
			_alt = interpreter!!.adaptivePredict(_input!!,468,context)
			while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					if (true){
					if (true){
	...
	fun  whenExpression() : WhenExpressionContext {
		...
		try {
			...
			this.state = 3143
			errorHandler.sync(this)
			_alt = interpreter!!.adaptivePredict(_input!!,482,context)
			while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					if (true){
					if (true){
					...
					this.state = 3138
					errorHandler.sync(this)
					_alt = interpreter!!.adaptivePredict(_input!!,481,context)
					while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER ) {
						if ( _alt==1 ) {
							if (true){
							if (true){
	...
	fun  whenEntry() : WhenEntryContext {
		...
		try {
			...
			this.state = 3171
			errorHandler.sync(this)
			_alt = interpreter!!.adaptivePredict(_input!!,486,context)
			while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					if (true){
					if (true){
	...
	fun  jumpExpression() : JumpExpressionContext {
		...
		try {
			...
			this.state = 3334
			errorHandler.sync(this)
			when ( interpreter!!.adaptivePredict(_input!!,513,context) ) {
			1   -> if (true){
			this.state = 3333
			expression()
			}
	...
	fun  typeModifiers() : TypeModifiersContext {
		...
		try {
			...
			do {
				...
				this.state = 3432 
				errorHandler.sync(this)
				_alt = interpreter!!.adaptivePredict(_input!!,528,context)
			} while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER )
			}
		}
		catch (re: RecognitionException) {
	...
	fun  typeParameterModifier() : TypeParameterModifierContext {
		...
		try {
			...
			this.state = 3468
			errorHandler.sync(this)
			_alt = interpreter!!.adaptivePredict(_input!!,533,context)
			while ( _alt!=2 && _alt!=INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					if (true){
					if (true){
